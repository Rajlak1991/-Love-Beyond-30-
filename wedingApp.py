...
# In-memory storage
users = {"admin": "yuvi1991"}  # admin username/password
...
def register():
    ...
    if len(username) < 3 or len(password) < 4:
        return "Username must be at least 3 chars and password 4+ chars!"
...
def submit_user_form():
    ...
    return f"Thank you {profiles[username]['full_name']}, your profile has been saved!"
